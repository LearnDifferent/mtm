...
(
    ...
    `display_order`        int(4)          NOT NULL DEFAULT 0 COMMENT 'Display Order',
    `permissions`          varchar(100)    NOT NULL DEFAULT 'guest:user:admin',
    `path`                 varchar(255)    NOT NULL DEFAULT '' COMMENT 'Routing Address',
    `component`            varchar(255)    NOT NULL DEFAULT '' COMMENT 'Vue Component',
    `query`                varchar(255)    NOT NULL DEFAULT '' COMMENT 'Vue Component Query (if any)',
    ...
    `created_by`           varchar(255)    NOT NULL DEFAULT 'Database User',
